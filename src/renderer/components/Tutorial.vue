...
<template>
    <div class="relative flex items-top justify-center min-h-screen bg-gray-700 sm:items-center sm:pt-0">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mt-8 bg-gray-800 overflow-hidden shadow sm:rounded-lg p-6">
                ...
                <p class="mt-4 pt-4 text-gray-300 border-t border-dashed">
                    To get started, remove <code
                    class="bg-gray-700 text-sm p-1 rounded border border-black">components/Tutorial.vue</code> and start coding in
                    <code class="bg-gray-700 text-sm p-1 rounded border border-black">pages/index.vue</code>. Have fun!
                </p>
            </div>
            <div class="flex justify-center pt-4 space-x-2">
                <a href="https://github.com/nuxt/nuxt.js" target="_blank">
                    <svg
                        class="w-6 h-6 text-gray-300 hover:text-gray-800"
